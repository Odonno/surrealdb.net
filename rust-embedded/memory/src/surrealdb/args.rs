...
pub trait Take {
	fn needs_one(self) -> Result<Value, Error>;
	fn needs_two(self) -> Result<(Value, Value), Error>;
	fn needs_three(self) -> Result<(Value, Value, Value), Error>;
	fn needs_one_or_two(self) -> Result<(Value, Value), Error>;
	fn needs_one_two_or_three(self) -> Result<(Value, Value, Value), Error>;
	fn needs_three_or_four(self) -> Result<(Value, Value, Value, Value), Error>;
}
