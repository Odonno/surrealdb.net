...
public class GuidConverterTests : BaseCborConverterTests
{
    ...
    public async Task Serialize()
    {
        ...
        result
            .Should()
            .Be("c7782430303031303230332d303430352d303630372d303830392d306130623063306430653066");
    }
    ...
    public async Task Deserialize()
    {
        var result = await DeserializeCborBinaryAsHexaAsync<Guid>(
            "c7782430303031303230332d303430352d303630372d303830392d306130623063306430653066"
        );
