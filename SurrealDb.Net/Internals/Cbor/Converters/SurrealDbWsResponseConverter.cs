...
internal class SurrealDbWsResponseConverter : CborConverterBase<ISurrealDbWsResponse>
{
    ...
    private readonly ICborConverter<SurrealDbWsLiveResponseContent> _surrealDbWsLiveResponseContentConverter;
    ...
    public SurrealDbWsResponseConverter(CborOptions options)
    {
        ...
        _surrealDbWsLiveResponseContentConverter =
            options.Registry.ConverterRegistry.Lookup<SurrealDbWsLiveResponseContent>();
    ...
    public override ISurrealDbWsResponse Read(ref CborReader reader)
    {
        ...
        if (!result.IsEmpty)
        {
            var content = _surrealDbWsLiveResponseContentConverter.Read(ref reader);
